package com.example.sarrawi.myapplication.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DBLOCATION = "/data/data/com.example.sarrawi.myapplication/databases/";
    ...
    public ArrayList<Adapter_zekr> getAllPrayerzekr() {

        ArrayList<Adapter_zekr> contactList = new ArrayList<Adapter_zekr>();
        // Select All Query
        String selectQuery = "SELECT * FROM zekr where name_id";
