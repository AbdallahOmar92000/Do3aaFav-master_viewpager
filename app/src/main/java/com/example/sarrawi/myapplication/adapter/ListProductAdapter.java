...
import com.example.sarrawi.myapplication.ServicesInformationActivity;
...
public class ListProductAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tvName = (TextView) convertView.findViewById(R.id.title1);
            holder.imgFav = (ImageView) convertView.findViewById(R.id.img_fav1);
            holder.Rv=(RelativeLayout) convertView.findViewById(R.id.card_view1);
...
//                    holder.fav.setBackgroundColor(Color.rgb(255, 0, 0));
        ...
        holder.Rv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, ServicesInformationActivity.class);
